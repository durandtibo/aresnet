...
the aresnet library for HTTP request retry behavior, timeouts, and error
handling. These constants provide sensible defaults for most use cases
but can be overridden when calling the HTTP request functions.
"""
